...
def dump_data():
	...
	run('cd /home/tukipenda/webapps/%s/CBT-Toolkit/cbt; python2.7 manage.py dumpdata auth.user sites.site --indent 4 > ~/bkups/cbt_production/django/Fixtures/auth_data.json' % env.app_folder)
