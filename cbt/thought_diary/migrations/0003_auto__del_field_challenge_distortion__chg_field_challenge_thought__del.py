...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('thought_diary_thought', 'distortion', self.gf('thought_diary.models.MultiSelectField')(default='', max_length=200, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Challenge.distortion'
        db.add_column('thought_diary_challenge', 'distortion', self.gf('thought_diary.models.MultiSelectField')(default='', max_length=200, blank=True), keep_default=False)
    ...
    models = {
        ...
        'thought_diary.thought': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {}),
            'distortion': ('thought_diary.models.MultiSelectField', [], {'max_length': '200', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
