...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('thought_diary_challenge', 'challenge_question', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['thought_diary.ChallengeQuestion']), keep_default=False)
    ...
    models = {
        ...
        'thought_diary.challenge': {
            ...
            'challenge_question': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['thought_diary.ChallengeQuestion']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
