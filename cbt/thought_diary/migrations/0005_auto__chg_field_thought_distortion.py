...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Thought.distortion' to match new field type.
        db.rename_column('thought_diary_thought', 'distortion', 'distortion_id')
        # Changing field 'Thought.distortion'
        db.alter_column('thought_diary_thought', 'distortion_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['thought_diary.Distortion'], null=True))

        # Adding index on 'Thought', fields ['distortion']
        db.create_index('thought_diary_thought', ['distortion_id'])


    def backwards(self, orm):
        
        # Removing index on 'Thought', fields ['distortion']
        db.delete_index('thought_diary_thought', ['distortion_id'])

        # Renaming column for 'Thought.distortion' to match new field type.
        db.rename_column('thought_diary_thought', 'distortion_id', 'distortion')
        # Changing field 'Thought.distortion'
    ...
    models = {
        ...
        'thought_diary.thought': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {}),
            'distortion': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['thought_diary.Distortion']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
