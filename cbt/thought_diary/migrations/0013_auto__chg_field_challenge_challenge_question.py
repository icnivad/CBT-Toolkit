...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Challenge.challenge_question'
        db.alter_column('thought_diary_challenge', 'challenge_question_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['thought_diary.ChallengeQuestion'], null=True))

        # Removing M2M table for field challenge_questions_answered on 'Thought'
        db.delete_table('thought_diary_thought_challenge_questions_answered')


    def backwards(self, orm):
        
        # Changing field 'Challenge.challenge_question'
        db.alter_column('thought_diary_challenge', 'challenge_question_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['thought_diary.ChallengeQuestion']))

        # Adding M2M table for field challenge_questions_answered on 'Thought'
        db.create_table('thought_diary_thought_challenge_questions_answered', (
        ...
        db.create_unique('thought_diary_thought_challenge_questions_answered', ['thought_id', 'challengequestion_id'])
