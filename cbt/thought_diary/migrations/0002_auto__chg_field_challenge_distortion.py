...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Challenge.distortion'
        db.alter_column('thought_diary_challenge', 'distortion', self.gf('thought_diary.models.MultiSelectField')(max_length=200))


    def backwards(self, orm):
        
        # Changing field 'Challenge.distortion'
        db.alter_column('thought_diary_challenge', 'distortion', self.gf('django.db.models.fields.CharField')(max_length=100))
